...
void Hvy3DScene::conbufSetDataHC()
{
    ...
    //  and the tessellation will still be drawn, only the mouse won't have any effect.
    //                      
...
void Hvy3DScene::CreateDeviceDependentResources()
{
    ...
    auto loadVS_2D_Task = DX::ReadDataAsync(L"FundamentalDomainVertexShader.cso");
    auto loadPS_01_Task = DX::ReadDataAsync(L"FundamentalDomainPixelShader.cso");
